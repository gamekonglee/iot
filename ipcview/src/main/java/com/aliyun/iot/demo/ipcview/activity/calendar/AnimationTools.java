...
public class AnimationTools {
     ...
     * @param Duration 动画时间
     */
    public void moveToViewBottom(final View v, View contain, long Duration) {
        if (contain.getVisibility() != View.VISIBLE || ismHiddenActionstart)
            return;
     ...
     * @param Duration 动画时间
     */
    public void bottomMoveToViewLocation(View v, View contain, long Duration) {
        if (contain.getVisibility() == View.VISIBLE)
            return;
